import 'package:t_mago/Resources/Components/card.dart';
import 'package:t_mago/Resources/Components/list_item.dart';
import 'package:t_mago/Resources/Models/Menu/list_item.model.dart';
import 'package:t_mago/Views/Mouvement/widgets/tracking.widget.dart';
            ...
            children: [
              ...
              ListItem(
                ...
                middleFields: ListItemModel(
                    displayLabel: true, title: 'Exp', value: 'Exp'),
              ...
              ListItem(
                ...
                middleFields: ListItemModel(
                    displayLabel: true, title: 'Dest', value: 'Dest'),
                keepMidleFields: true,
                backColor: AppColors.kWhiteColor,
                textColor: AppColors.kBlackColor,
                detailsFields: const [],
                      ...
                      children: [
                        ...
                        ...List.generate(data.tracking!.length, (index) {
                          MouvementTrackingModel trackData =
                              data.tracking![index];
                          return TrackingWidget.buildTrackWidget(
      ...
      child: Card(
        ...
        child: Column(children: [
          ...
          TrackingWidget.buildTrackWidget(
              ...
              subtitle: 'Goma, av. du port',
              color: AppColors.kBlackColor,
              isLast: false,
              date: ''),
          TrackingWidget.buildTrackWidget(
              title: data.destinationStore?.name ?? 'Bukavu',
              subtitle: 'Bukavu, com kadutu',
              color: AppColors.kBlackColor,
              isLast: true,
              date: ''),
          // SizedBox(
